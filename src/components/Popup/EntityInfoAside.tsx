...
import classes from './EntityInfoAside.module.css';
...
// Airspace content for aside
const AirspaceAsideContent: React.FC<{ airspace: AirspaceDto | SpecialUseAirspaceDto; onClose: () => void }> = ({ airspace, onClose }) => {
...
// PIREP content for aside
const PirepAsideContent: React.FC<{ pirep: PirepDto; onClose: () => void }> = ({ pirep, onClose }) => {
  return (
    <Stack gap={0} h="100%">
      {/* Header */}
      <Box className={classes.header}>
...
// Obstacle content for aside
const ObstacleAsideContent: React.FC<{ obstacle: ObstacleDto; onClose: () => void }> = ({ obstacle, onClose }) => {
  const isLit =
...
// AIRMET/SIGMET content for aside
const AirsigmetAsideContent: React.FC<{ airsigmet: AirsigmetDto; onClose: () => void }> = ({ airsigmet, onClose }) => {
...
// G-AIRMET content for aside
const GAirmetAsideContent: React.FC<{ gairmet: GAirmetDto; onClose: () => void }> = ({ gairmet, onClose }) => {
